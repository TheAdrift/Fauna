...
---[[	Add our player to the view in the appropriate spot.
        self.pFloor = FloorCollider:new{x = the.hero.x, y = the.hero.y}
	...
	onUpdate = function (self)
		self.map:displace(self.pFloor)
		self.objects:collide(self.objects)
		self.objects:collide(self.pFloor)
		...
		if not the.dragon.active then
			...
			-- otherwise, move on to the next stage
				...
				self.pFloor.x = the.hero.x
				self.pFloor.y = the.hero.y
